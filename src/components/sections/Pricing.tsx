  ...
  uretici: [
    {
      ...
      features: ["10 urun", "Temel raporlama", "Barkod olusturma", "E-posta destek"],
      popular: false,
    },
    {
      name: "Buyume",
      ...
      features: ["50 urun", "Gelismis raporlama", "Oncelikli destek", "Otomatik mutabakat"],
      popular: true,
    },
    {
      name: "Pro",
      ...
      features: ["Sinirsiz urun", "PDF rapor cikti", "Oncelikli listeleme", "7/24 destek"],
      popular: false,
    },
  ],
  satici: [
    {
      ...
      features: ["10 uretici baglantisi", "Barkodla satis", "Temel raporlama", "E-posta destek"],
      popular: false,
    },
    {
      name: "Buyume",
      ...
      features: ["50 uretici baglantisi", "Gelismis raporlama", "Oncelikli destek", "Otomatik mutabakat"],
      popular: true,
    },
    {
      name: "Pro",
      ...
      features: ["Sinirsiz baglanti", "Coklu sube destegi", "PDF rapor cikti", "7/24 destek"],
      popular: false,
    },
  ],
};
...
export default function Pricing() {
  ...
  return (
    <section id="fiyatlar" className="py-24" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-10">
          ...
          <p className="text-lg text-text-body">
            14 gun ucretsiz dene. Kredi karti gerekmez.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {plans[tab].map((plan, i) => (
            ...
            >
              ...
              <a
                href="#"
                className="block w-full py-3.5 rounded-xl bg-primary text-white font-semibold hover:bg-primary-hover transition-colors"
              >
                Secim Yap
              </a>
            </motion.div>
